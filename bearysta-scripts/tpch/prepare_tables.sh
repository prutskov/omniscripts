...
if [ ! -d "gen_$1/data-$2-$3" ]; then
    mkdir -p gen_$1/data-$2-$3 && ../../../omniscidb/build/bin/initdb --data gen_$1/data-$2-$3

    python3 prepare_tables.py gen_$1 $2 $3

    ../../../omniscidb/build/bin/omnisci_server --db-query-list=gen_$1/create_tables.sql --exit-after-warmup --data gen_$1/data-$2-$3 --log-severity-clog=INFO
fi
